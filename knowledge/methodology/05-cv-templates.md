...
**Master reference:** the candidate profile (`profile/` JSON) is the sole source of facts; existing tailored resumes may be read for structure and phrasing only, never as a source of claims
